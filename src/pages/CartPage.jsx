...
const CartPage = () => {
  ...
  const hiddenCart = useSelector((state) => state.hiddenCart);
  ...
  return (
    <div className="relative top-16 flex h-[85vh] w-screen max-w-[1100px] flex-col items-center gap-2 mm:top-24 tp:top-36 tp:col-start-2 tp:col-end-8 tp:row-start-1 tp:row-end-7 tp:gap-4">
